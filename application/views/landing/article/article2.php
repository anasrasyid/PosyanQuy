        ...
        <div class="tab-pane fade show active d-flex justify-content-center " style="margin-top: 50px;margin: 30px;margin-bottom: 150px;">
            <ul class="nav">
              <div class="bg-white rounded" style="width: 900px;margin: 12px;">
                ...
                <div class="card-body flex-column d-flex">
                  ...
                  <p class="card-text">
                    ...
                    <ol>
                        ...
                        <li>Berfungsi sebagai wahana gerakan reproduksi keluarga sejahtera, gerakan ketahanan keluarga dan gerakan ekonomi keluarga sejahtera.</li>
                    </ol> 
                    ...
                    <ol>
                        <li>Jenis Pelayanan Minimal Kepada Anak</li>
                        ...
                        <li>Pelayanan Tambahan yang Diberikan </li>
                ...
                <a href="https://bulelengkab.go.id/bankdata/pengertian-posyandu-kegiatandefinisi-tujuan-fungsi-manfaat-dan-pelaksanaan-posyandu-33">Sumber</a>
